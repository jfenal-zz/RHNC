Find the right Getopt::Long version introducing String parsing --> the last one, 2.36 :(

RHNC::SystemGroup->as_string
RHNC::System->as_string
RHNC::Kickstart->as_string
...
rhnc-ak :
- toggle/set univ_default  --> -u => -u 0|1
